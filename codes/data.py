...
class TrainDataset(Dataset):
    def __init__(self, data_reader: DataReader, neg_size: int, batch_type: BatchType):
        ...
        # data_reader.entity_dict : { ... '10902591': 40936, '01799629': 40937, '12646397': 40938, '11375087': 40939, '10196845': 40940, '01165112':40941, '01527194': 40942}

        self.triples = data_reader.train_data   # head, relation, tail --> [(26353, 1, 26927), (23646, 1, 10239), (615, 1, 3433), (14829, 4, 14828), (17107, 0, 5067), (24026, 0, 11726), (3574, 6, 29637), (22554, 5, 774)]]
        ...
        # self.hr_map : (head,rel) : tail
        # self.tr_map : (tail, rel) : head
        # self.hr_freq : (head, rel) : 몇개인지
        # self.tr_freqn   : (tail, rel) : 몇개인지
    ...
    def __getitem__(self, idx: int):
        ...
        pos_triple = self.triples[idx]  # head, relation, tail이 id값으로 주어짐
        ...
        while neg_size < self.neg_size:
            ...
            neg_triples_tmp = neg_triples_tmp[mask] #실제 triple이 있는 경우 False로 masking됨
